...
[Image of Glomerular Filtration Rate (GFR) and kidney function stages]
...
The app calculates the estimated Creatinine Clearance ($CrCl$) using:
$$CrCl = \frac{(140 - \text{age}) \times \text{weight (kg)}}{0.814 \times \text{creatinine (umol/L)}} \times (0.85 \text{ if female})$$

### Pediatric Antibiotic Rule
Calculations follow the $80\text{--}90 \text{ mg/kg/day}$ protocol, split into two doses (BD).
